...
toc:
  ...
  - name: Get artefacts/images
  - name: Run images
  - name: Attached mode
  - name: Detach mode
  - name: Port forwarding/binding
  - name: Naming containers upon run
  - name: Running with environmental variables
  - name: Mounting volume for persistence of data in containers
  ...
  - name: Running containers in the same network
  - name: Docker Compose
