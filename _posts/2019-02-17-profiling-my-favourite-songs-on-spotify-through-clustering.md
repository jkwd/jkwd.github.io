...
Let’s try another method called t-Distributed Stochastic Neighbor Embedding(t-SNE). t-SNE performs well for visualizing high dimension data. For more details, you may read this [tutorial](https://www.datacamp.com/tutorial/introduction-t-sne).
